...
, CONSTRAINT rental_lab_item_fk1 FOREIGN KEY (rental_id) REFERENCES rental_lab (rental_id)
, KEY rental_item_lab_fk2 (item_id)
, CONSTRAINT rental_lab_item_fk2 FOREIGN KEY (item_id) REFERENCES item_lab (item_id)
, KEY rental_item_lab_fk3 (created_by)
, CONSTRAINT rental_lab_item_fk3 FOREIGN KEY (created_by) REFERENCES system_user_lab (system_user_id)
, KEY rental_itedm_lab_fk4 (last_updated_by)
