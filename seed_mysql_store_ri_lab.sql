...
-- --------------------------------------------------------------------------------
use studentdb;
\. /home/student/Data/cit225/mysql/lab2/lab2.sql
\. /home/student/Data/cit225/mysql/lab4/seed_mysql_store_ri.sql
-- Open log file.
TEE seed_mysql_store_ri_lab.txt
...
ALTER TABLE member_lab ADD CONSTRAINT member_lab_fk3 FOREIGN KEY(member_type) REFERENCES common_lookup(common_lookup_id);
...
CREATE OR REPLACE VIEW contacts AS
  ...
  ,        a.city
  ,        a.state_province
  FROM     member_lab m JOIN contact_lab c ON m.member_id = c.member_id JOIN address_lab a ON c.contact_id = a.contact_id;
...
select count(*) from rental_lab;
select count(*) from contact;
select count(*) from contact_lab;
select count(*) from address;
select count(*) from address_lab;
